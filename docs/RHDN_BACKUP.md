...
Sequence 5 adds 31 distinct patch outputs across 11 games from the public
...
- Excluded 14 outputs already represented by existing entries or another patch
  encoding in the backup, leaving 31 new entries.
...
Sequence 5 contains 1,599 total entries. Archive omissions remain pending and
